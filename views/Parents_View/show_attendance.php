  ...
  $isLoggedIn = 0;
      if(!(isset($_SESSION['session_id']))){
        ...
        echo "not session set up";
         ...
         //echo $std_id;
         $student_at_show_sql = "SELECT * FROM admin_add_student_course WHERE std_id=".$_SESSION['session_id'];
         $student_at_show_result = $con->query($student_at_show_sql);
            ...
            <form action="" method="post">
                <div class="row" style="text-align: center;">
                    ...
                    <div class="form-group col-sm-4">
                        <label for="semister" class="col-xs-4" style="line-height: 20px;text-align: center;color: rgb(13, 144, 157);font-size: 18px">
                            Course code:</label>
                        <div class="col-xs-8">
                            ...
                            include "connection.php";
                             ...
                             while ( $student_at_show_row= $student_at_show_result->fetch_assoc()) {
                            ?>
                                <option value="<?php echo $student_at_show_row['course_code']?>"><?php echo $student_at_show_row['course_code']?></option>
                    ...
                    <div class="form-group col-sm-4">
                        <label for="semister" class="col-xs-4" style="line-height: 20px;text-align: center;color: rgb(13, 144, 157);font-size: 17px">
                            Student Id:</label>
                        <div class="col-xs-8">
                            <input type="text" name="student_id" placeholder="student id" value="<?php echo $std_id?>">
                        </div>
                    </div>
