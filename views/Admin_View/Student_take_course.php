...
if (isset($_POST['take_course'])) {
 ...
 $std_id = $_POST['std_id'];
 //echo $std_id;
    $sql="INSERT INTO admin_add_student_course VALUES ('','$std_id','$course_title','$course_code','$semister','$assign_teacher')";
                    ...
                    ?>  
                        ...
                        <tr>
                          <form method="post" action=""> 
                            ...
                            <td>
                               <?php echo $assign_course_show_row['name']?>  
                               <input type="hidden" name="assign_teacher" value="<?php echo $assign_course_show_row['name']?>">
                            </td>
                            <td>
                            ...
                            <td>
                                <select name="std_id">
                                    ...
                                    ?> 
                                    <option value="<?php echo $student_show_row['id']?>"><?php echo $student_show_row['name']?></option>
                                    <!-- <input type="hidden" name="std_id" value="<?php echo $student_show_row['std_id']?>"> -->
                                    <?php
                                    }
                                    ?>
                                </select>
